...
public class Activity {
  ...
  public double getPerformance() {
    ...
    {
        pe = w*(this.releaseTime - this.activationTime);
    }
    ...
    {
        pt = w*(this.terminationTime - this.dueTime);
    }
    return pe + pt;
  }
  ...
  public void store() {
    // YOUR CODE here
    tempActivationTime = this.activationTime;
    tempTerminationTime = this.terminationTime;
  }
